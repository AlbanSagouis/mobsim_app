...
tagList(
   shinyjs::useShinyjs(), # Shiny was unhappy with this command being inside navbarPage
   navbarPage(
               ...
               sidebarLayout(
                  sidebarPanel(
                     ...
                     fluidRow(
                        ...
                        column(width = 4, numericInput(inputId = "sadNewN", label = "N per species", value = 100, min = 1, max = 5000, step = 1)),
