Help <- list(
   ...
   CVsliderLnorm = list(title = "Coefficient of variation of abundances", content = paste0("CV = standard deviation of abundances divided by the mean abundance. Parameter controlling the shape of SAD: low values make more even communities. ", HTML('<a href="https://en.wikipedia.org/wiki/Relative_species_abundance#Log_normal_(Preston_1948)" rel="noopener noreferrer" target="_blank">Wiki article</a>'))),
	CVsliderGeom = list(title = "Constant proportion", content = paste0("Within the geometric series each species' level of abundance is a sequential, constant proportion (k) of the total number of individuals in the community. Thus if k is 0.5, the most common species would represent half of individuals in the community (50%), the second most common species would represent half of the remaining half (25%), the third, half of the remaining quarter (12.5%) and so forth.", HTML('<a href="https://en.wikipedia.org/wiki/Relative_species_abundance#Geometric_series_(Motomura_1932)"  rel="noopener noreferrer" target="_blank">Wiki article</a>')), short_content = paste0("Constant proportion (k) of the total number of individuals in the community. ", HTML('<a href="https://en.wikipedia.org/wiki/Relative_species_abundance#Geometric_series_(Motomura_1932)"  rel="noopener noreferrer" target="_blank">Wiki article</a>'))),
   ...
   spatagg = list(title = "Aggregation parameter", content = "Parameter controling how clustered the individuals are around the mother points. Values must be in ]0 ; 1]. Either a single value and all species will be similarly clustered or as many values as species, separated by commas."),
