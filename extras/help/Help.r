Help <- list(
   ...
   CVsliderLnorm = list(title = "Coefficient of variation of abundances", content = paste0("CV = standard deviation of abundances divided by the mean abundance. Parameter controlling the shape of SAD: low values make more even communities. ", HTML('<a href="https://en.wikipedia.org/wiki/Relative_species_abundance#Log_normal_(Preston_1948)" rel="noopener noreferrer" target="_blank">Wiki article</a>'))),
	CVsliderGeom = list(title = "Constant proportion", content = paste0("Within the geometric series each species' level of abundance is a sequential, constant proportion (k) of the total number of individuals in the community. Thus if k is 0.5, the most common species would represent half of individuals in the community (50%), the second most common species would represent half of the remaining half (25%), the third, half of the remaining quarter (12.5%) and so forth.", HTML('<a href="https://en.wikipedia.org/wiki/Relative_species_abundance#Geometric_series_(Motomura_1932)"  rel="noopener noreferrer" target="_blank">Wiki article</a>')), short_content = paste0("The smaller, the more even. Constant proportion (k) of the total number of individuals in the community. ", HTML('<a href="https://en.wikipedia.org/wiki/Relative_species_abundance#Geometric_series_(Motomura_1932)"  rel="noopener noreferrer" target="_blank">Wiki article</a>'))),
	CVsliderLs = list(title = "Alpha constant", content = paste0("Value in the interval ]0 ; +Inf], the higher, the more species. Does not take S into account. ", HTML('<a href="https://en.wikipedia.org/wiki/Relative_species_abundance#Logseries_(Fisher_et_al_1943)" rel="noopener noreferrer" target="_blank">Wiki article</a>'))),
   spatagg = list(title = "Aggregation parameter", content = "Parameter controling how clustered the individuals are around the mother points: the value is the mean distance bitween the mother point and the individuals around it. Values must be in ]0 ; 1]. Either a single value and all species will be similarly clustered or as many values as species, separated by commas."),
   ...
   spatcoef = list(title = "Clustering parameter", content = "A single value can be specified and all species will have the same number of cores OR one number can be given per species (separated by commas). '0' gives no clustering even if Spatial aggregation parameter value is low."),
   ...
   # Reroducibility table
   reproducibilityTable_output = list(title = "Summary of all simulation runs", content = "Select rows to delete simulations using the Remove selected simulations button or compare the selected communities."),
